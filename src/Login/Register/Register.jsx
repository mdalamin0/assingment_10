    ...
    return (
        <div className=' form-width mx-auto my-5 border rounded px-4 py-5 shadow' >
            ...
            <Form onSubmit={handleRegister}>
                ...
                <div className="mt-5">
                    <p onClick={handleRegisterWithGoogle} className="btn border border-2 w-100 "> <img className='' style={{ width: '20px' }} src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/53/Google_%22G%22_Logo.svg/2008px-Google_%22G%22_Logo.svg.png" alt="" /> Continue with Google</p>
                </div>
                <div>
                    <p onClick={handleRegisterWithGithub} className="btn border border-2 w-100 "> <img className='' style={{ width: '30px' }} src="https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png" alt="" /> Continue with Github</p>
                </div>
            </Form>
        </div>
    );
